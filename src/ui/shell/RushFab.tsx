...
export function RushFab() {
  ...
  */
  ...
  const label = adPending ? t(premium ? 'İşlem sürüyor…' : 'Reklam…') : active ? t('{dk} dk', { dk: remaining }) : t('Canlandır');
  const title = adPending
    ...
    : !open
      ...
      : active
        ...
        : t(premium ? 'Premium: müşteri akınını reklamsız başlat.' : 'Dükkânı Canlandır — ödüllü reklam izle, müşteri geliş aralığı 90 dakika boyunca kısalsın.');
