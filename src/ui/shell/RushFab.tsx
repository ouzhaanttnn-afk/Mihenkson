...
export function RushFab() {
  ...
  */
  ...
  const label = adPending ? t('Reklam…') : active ? t('{dk} dk', { dk: remaining }) : t('Müşteri Akını');
  const title = adPending
    ...
    : !open
      ...
      : active
        ...
        : t('Müşteri Akını — reklam izle, 90 oyun dakikası boyunca daha sık müşteri gelsin.');
