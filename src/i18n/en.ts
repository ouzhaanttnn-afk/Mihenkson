...
export const EN: Record<string, string> = {
  ...
  "Tahmin · kesin satış teklifi değildir.": "Estimate · not a firm sale quote.",
  "Sürüm": "Version",
  "Bu sürümde yenilikler": "What's new",
  "Müşteriye göre stok önerisi ve daha net satış tutarları.": "Customer-based stock suggestions and clearer sale amounts.",
  "Klasik görünüm, sade stok kontrolleri ve pazarlık analizi.": "Classic appearance, streamlined stock controls and trade analysis.",
  "Kupa düğmesiyle aylık HAS sıralaması ekranı. Canlı sezon ayrıca etkinleştirilir.": "Monthly fine-gold ranking screen via the trophy. Live seasons require separate activation.",
  "Reklam durum mesajları ve müşteriyi tek sefer geri çağırma.": "Ad status messages and a one-time customer recall.",
  "Reklam hazırlanıyor. Biraz sonra tekrar dene.": "The ad is being prepared. Try again shortly.",
  "Şu an uygun reklam bulunamadı. Daha sonra tekrar deneyebilirsin.": "No suitable ad is available right now. You can try again later.",
  "Reklam yüklenemedi. İnternet bağlantını kontrol et.": "The ad could not load. Check your internet connection.",
  "Reklam şu anda gizlilik izni nedeniyle kullanılamıyor. Gizlilik ve destek bölümünü kontrol et.": "Ads are currently unavailable due to privacy consent. Check Privacy and Support.",
  "Reklam gösterilemedi. Ödül hakkın kullanılmadı; tekrar deneyebilirsin.": "The ad could not be shown. Your reward opportunity was not used; you can try again.",
  "Reklam ödül kazanılmadan kapandı. Ödül verilmedi.": "The ad closed before a reward was earned. No reward was granted.",
  "Ödüllü reklamlar yalnız mobil uygulamada kullanılabilir.": "Rewarded ads are only available in the mobile app.",
  "Premium durumu doğrulanamadı. Bağlantını kontrol edip tekrar dene.": "Premium status could not be verified. Check your connection and try again.",
  'Premium ile aynı müşteriyi reklamsız geri çağır ve son teklifini yap.': 'Recall the same customer ad-free with Premium and make your final offer.',
  "İşlem sürüyor…": "Processing…",
  "Premium aktif. İyi oyunlar!": "Premium is active. Enjoy the game!",
  "Satın alma Apple onayı bekliyor. Onaylandığında Premium açılacak.": "Your purchase is awaiting Apple approval. Premium will unlock when approved.",
  "Satın alma iptal edildi.": "Purchase cancelled.",
  "Premium satın alımın geri yüklendi.": "Your Premium purchase has been restored.",
  "Bu Apple hesabında Premium satın alımı bulunamadı.": "No Premium purchase was found for this Apple Account.",
  "İşlem doğrulanamadı. Bağlantını kontrol edip tekrar dene veya satın alımları geri yükle.": "Could not verify the transaction. Check your connection and try again or restore purchases.",
  "Reklamsız kuyumculuk": "Your shop, without ads",
  "Bir kez satın al, kalıcı olarak reklamsız oyna.": "Buy once and play ad-free permanently.",
  "Zorunlu reklamlar tamamen kalkar.": "All mandatory ads are removed.",
  "Ödülleri reklam izlemeden, ilgili düğmeye dokunarak alırsın.": "Claim rewards by tapping their buttons, without watching ads.",
  "Mevcut günlük haklar ve bekleme süreleri korunur.": "Existing daily limits and cooldowns still apply.",
  "Premium aktif": "Premium active",
  "Tek seferlik · Abonelik değil": "One-time purchase · Not a subscription",
  "Premium Satın Al": "Buy Premium",
  "Satın alma iOS uygulamasında kullanılabilir.": "Purchases are available in the iOS app.",
  "App Store fiyatı şu anda alınamıyor. Tekrar deneyebilirsin.": "The App Store price is currently unavailable. Please try again.",
  "App Store bağlantısı kurulamadı.": "Could not connect to App Store.",
  "Fiyat yükleniyor…": "Loading price…",
  "App Store’a bağlanılıyor…": "Connecting to App Store…",
  "Reklamsız Kuyumculuk": "Ad-Free Goldsmithing",
  "Zorunlu reklamlar kalkar.": "Mandatory ads are removed.",
  "Ödülleri reklam izlemeden alırsın.": "Claim rewards without watching ads.",
  "Tekrar Dene": "Try Again",
  "{fiyat} ile Satın Al": "Buy for {fiyat}",
  "Gerçek para ile satın alınır; oyun içi nakit kullanılmaz.": "Purchased with real money, not in-game cash.",
  "Satın Alımları Geri Yükle": "Restore Purchases",
  "Premium: müşteri akınını reklamsız başlat.": "Premium: start a customer rush without ads.",
  "{n}x hızı reklamsız aç": "Unlock {n}x speed without ads",
  "Premium ile {gun} gün ücretsiz aç": "Unlock free for {gun} days with Premium",
  "Premium ile {gun} gün aç": "Unlock for {gun} days with Premium",
  "{n} personel geçici açık — {gun} gün kaldı.": "{n} staff temporarily unlocked — {gun} days left.",
  "Bugünkü personel gideri ({tutar}) ücretsizleşti.": "Today's staff expense ({tutar}) has been waived.",
  "Premium: bugün ücretsiz olsun": "Premium: waive today's cost",
  'Bu sürümde yetenek puanı kazanımı ve kademe açma kapalıdır. Mevcut temel etkiler aşağıda gösterilir.': 'Skill points and rank upgrades are not available in this version. Current base effects are shown below.',
  'Anlaşma odaklı': 'Deal focused',
  'Kâr odaklı': 'Profit focused',
  'Teklif tarzı': 'Offer style',
  'Kabul garantisi değildir.': 'Acceptance is not guaranteed.',
  'Teklifin': 'Your offer',
  'Tahmini kazanç': 'Estimated gain',
  'Satış kârı': 'Sale profit',
  ...
  'Satış tutarı': 'Sale proceeds',
  'Toplam maliyet': 'Total cost',
  'Net kâr / zarar': 'Net profit / loss',
  'Ödenen tutar': 'Amount paid',
  'Ürün stoğa girdi. Kâr, ürün satıldığında gerçekleşir.': 'Item added to stock. Profit is realized when it sells.',
  'İşlem değerlendirmesi': 'Deal review',
  'Kabul Et · {tutar}': 'Accept · {tutar}',
  'Maliyetinin altı zarardır': 'Below cost means a loss',
  'Satış kârı, fiyatın ile maliyetin arasındaki farktır. Hazır teklif seçebilir veya tutara dokunup kendin ayarlayabilirsin.': 'Sale profit is the difference between your price and cost. Choose a preset or tap the amount to set your own price.',
  'Hazır teklif seç veya tutara dokunup kendin ayarla. Alıştaki kazanç tahminidir; satışa kadar gerçekleşmez.': 'Choose a preset or tap the amount to adjust it. Buying gains are estimates, not realized until the item sells.',
  ...
  'Stok gerekli': 'Stock required',
  'Talebe uygun ürün stokta yok': 'No matching item in stock',
  'Ürünü Temin Et': 'Source Item',
  'Müşteri İçin Stok Temin Et': 'Source Stock for Customer',
  'Talebe uygun ürünü al; Kapat dediğinde aynı müşteriye döneceksin. Kullanılabilir nakit:': 'Buy a matching item; Close returns you to the same customer. Available cash:',
  'Ürünü Temin Et ile uygun stoğu alıp aynı müşteriye dönebilirsiniz.': 'Use Source Item to buy matching stock and return to the same customer.',
  'Atölye hazırlanıyor': 'Preparing the workshop',
  'Vitrin düzenleniyor': 'Arranging the showcase',
  'Piyasa bağlanıyor': 'Connecting to the market',
  'Hazır': 'Ready',
  ...
  */
  ...
  'Yüksek': 'High',
  'Sert': 'Hard bargain',
  'Kâr sınırı': 'Profit limit',
  'Ticaret başarılı': 'Trade successful',
  'Anlaşma tamamlandı': 'Deal complete',
  '0 sabır': '0 patience',
  '-1 sabır': '-1 patience',
  'Sert teklif': 'Hard offer',
  'Dengeli teklif': 'Balanced offer',
  'Ölçülü': 'Measured',
  'Cömert': 'Generous',
  'Dikkat': 'Caution',
  'Sağlıklı': 'Healthy',
  ...
  'Özel Paketler': 'Special Packs',
  'İsteğe bağlı oyun içi paketler ve sezonluk seçkiler': 'Optional in-game packs and seasonal selections',
  'Bir hediye hazırlıyoruz': 'We are preparing a gift',
  'Oyun deneyimini renklendirecek isteğe bağlı özel paketler burada yer alacak.':
    'Optional special packs that add variety to your experience will appear here.',
  'Çerçeveler': 'Frames',
  ...
  */
  ...
  'Kasa Desteği': 'Cash Support',
  'Alındı': 'Claimed',
  'Kahve Molası': 'Coffee Break',
  '+sabır': '+patience',
  'Reklam tamamlanmadı — kasa desteği alınmadı.': 'The ad did not finish — cash support was not granted.',
  'Çarşı desteği kasaya eklendi · {tutar}': 'Bazaar support was added to the till · {tutar}',
  'Reklam tamamlanmadı — sabır yenilenmedi.': 'The ad did not finish — patience was not restored.',
  'Kahve molası müşterinin sabrını tazeledi.': "A coffee break restored the customer's patience.",
  'Usta Görüşü': 'Master Opinion',
  '1 ipucu': '1 hint',
  'Reklam tamamlanmadı — usta görüşü alınmadı.': 'The ad did not finish — no master opinion was granted.',
  'Usta bir belirsiz alanı doğruladı.': 'The master verified one uncertain field.',
  'Ek Teklif': 'Extra Offer',
  '+1 hak': '+1 chance',
  'Reklam tamamlanmadı — ek teklif hakkı verilmedi.': 'The ad did not finish — no extra offer was granted.',
  'Müşteri bir ek teklif için masada kaldı.': 'The customer stayed for one extra offer.',
  'Geri Çağır': 'Call Back',
  'Son müşteri': 'Last customer',
  'Reklam tamamlanmadı — müşteri geri dönmedi.': 'The ad did not finish — the customer did not return.',
  'Son müşteri düşük sabırla kuyruğa döndü.': 'The last customer returned to the queue with low patience.',
  '1 Gün Dene': 'Try for 1 Day',
  'Bugün denendi': 'Tried Today',
  'Günün Fırsatını Dene': "Try Today's Pick",
  'Reklam tamamlanmadı — kozmetik deneme açılmadı.': 'The ad did not finish — the cosmetic trial was not unlocked.',
  '{ad} bugün denemeye açıldı.': '{ad} is available to try today.',
  'Reklam tamamlanmadı — günün fırsatı açılmadı.': "The ad did not finish — today's pick was not unlocked.",
  'Günün kozmetiği açıldı · {ad}': "Today's cosmetic is unlocked · {ad}",
  'Ödüllü Tedarik Avantajları': 'Rewarded Supply Benefits',
  'Tedarik Ekspresi': 'Supply Express',
  'Tedarik Ekspresi Hazır': 'Supply Express Ready',
  'Ücretsiz Nakliye': 'Free Delivery',
  'Ücretsiz Nakliye Hazır': 'Free Delivery Ready',
  'Hazırlanan avantaj sıradaki toptancı alımında otomatik uygulanır.': 'The prepared benefit is applied automatically to the next wholesale purchase.',
  'Tedarik Ekspresi · vade farkı yok': 'Supply Express · no financing charge',
  'Ücretsiz nakliye · {tutar} indirim': 'Free delivery · {tutar} discount',
  'Reklam tamamlanmadı — tedarik avantajı açılmadı.': 'The ad did not finish — the supply benefit was not unlocked.',
  'Sıradaki toptancı alımında vade farkı alınmayacak.': 'No financing charge will apply to the next wholesale purchase.',
  'Reklam tamamlanmadı — ücretsiz nakliye açılmadı.': 'The ad did not finish — free delivery was not unlocked.',
  'Sıradaki toptancı alımının nakliyesi ücretsiz.': 'Delivery is free on the next wholesale purchase.',
  'Ücretsiz nakliye indirimi · {tutar}': 'Free delivery discount · {tutar}',
  'Atölye Mesaisi · −1 gün': 'Workshop Overtime · −1 day',
  'Bugün kullanıldı': 'Used Today',
  'Reklam tamamlanmadı — atölye mesaisi başlamadı.': 'The ad did not finish — workshop overtime did not start.',
  'Atölye mesaisi işi tamamladı.': 'Workshop overtime completed the job.',
  'İşin kalan süresi bir gün azaldı.': 'The remaining job time was reduced by one day.',
  'Yakında': 'Coming Soon',
  ...
  */
  ...
  'Tedarik Ekspresi hazır · ilk vadeli alımda uygulanır':
    'Supply Express ready · applies to the first financed purchase',
  'Çarşı sponsor desteği': 'Bazaar sponsor support',
  '{karakter} · Gün {gun} · {haftaGunu} · Semt itibarı {itibar}':
    '{karakter} · Day {gun} · {haftaGunu} · Neighbourhood standing {itibar}',
  '{karakter} · Finans özetini göster': '{karakter} · Show financial summary',

  // ——— Görsel alternatif metinleri ———
  '14 ayar altın kolye': '14K gold necklace',
  '18 ayar altın kolye': '18K gold necklace',
  '14 ayar altın halka küpe': '14K gold hoop earrings',
  '925 ayar gümüş zincir': 'Sterling silver chain',
  'Zirkon taşlı gümüş yüzük': 'Silver ring with zircon',
  'İşlemeli antika gümüş kutu': 'Engraved antique silver box',
  'Taşlı altın yüzük': 'Gold ring with gemstone',
  '18 ayar altın tektaş yüzük': '18K gold solitaire ring',
  'Ametist taşlı vintage altın broş': 'Vintage gold brooch with amethyst',
  'Kabartma desenli koleksiyon altın sikkesi': 'Embossed collectible gold coin',
  'Altın halka küpe': 'Gold hoop earrings',
  'İşlemeli gümüş obje': 'Engraved silver object',
  'Vintage altın broş': 'Vintage gold brooch',
  'Mor mine ve altın profil rozeti': 'Purple enamel and gold profile badge',
  'Ametist ve altın avatar çerçevesi': 'Amethyst and gold avatar frame',
  'Premium kuyumcu dükkânı': 'Premium jewellery shop',
  'Kuyumcu dükkânı dekorasyon seçkisi': 'Jewellery shop decoration collection',
  'Prestij yaşam ürünü': 'Prestige lifestyle item',
  'Gümüş telkari avatar çerçevesi': 'Silver filigree avatar frame',
  'Pirinç avatar çerçevesi': 'Brass avatar frame',
  'Ametist avatar çerçevesi': 'Amethyst avatar frame',
  'Hanedan avatar çerçevesi': 'Dynasty avatar frame',
  'Mine işi avatar çerçevesi': 'Enamel avatar frame',
  'Sedef kakma avatar çerçevesi': 'Mother-of-pearl avatar frame',
  'Pırlanta avatar çerçevesi': 'Diamond avatar frame',
  'İlk 5 kilogram HAS başarı rozeti': 'First 5 kg fine-gold achievement badge',
  'Çırak kuyumcu rozeti': 'Apprentice jeweller badge',
  'Mihenk ustası rozeti': 'Touchstone master badge',
  'Çarşı reisi lonca rozeti': 'Bazaar master guild badge',
  'Kapalıçarşı klasik kuyumcu dükkânı': 'Classic Grand Bazaar jewellery shop',
  'Gece ametisti kuyumcu dükkânı': 'Night amethyst jewellery shop',
  'Fildişi saray kuyumcu dükkânı': 'Ivory palace jewellery shop',
  'Art Deco pirinç kuyumcu dükkânı': 'Art Deco brass jewellery shop',
  'Mermer ve cam kuyumcu dükkânı': 'Marble and glass jewellery shop',
  'Altın Çağ kuyumcu sarayı': 'Golden Age jewellery palace',
  'Geleneksel çay ocağı takımı': 'Traditional tea service',
  'Koyu kadife tezgâh örtüsü': 'Dark velvet counter cloth',
  'Prestij kuyumcu kasası': 'Prestige jeweller safe',
  'İpek Hereke halısı': 'Silk Hereke carpet',
  'Ceviz vitrin takımı': 'Walnut display set',
  'Zırhlı çelik kasa dairesi': 'Armoured steel vault',
  'Osmanlı sikke koleksiyonu': 'Ottoman coin collection',
  'Antika terazi arşivi': 'Antique scale archive',
  'Nadir taş arşivi': 'Rare gemstone archive',
  'Mühür yüzük kabinesi': 'Signet ring cabinet',
  'Saray işçiliği arşiv dolabı': 'Palace craftsmanship archive cabinet',
  'İsviçre mekanik saati': 'Swiss mechanical watch',
  'Boğaz manzaralı şehir rezidansı': 'City residence with Bosphorus view',
  'Boğaz villası': 'Bosphorus villa',
  'Tarihî Boğaz yalısı': 'Historic Bosphorus mansion',
  'Özel motoryat': 'Private motor yacht',
  'Lüks yat': 'Luxury yacht',
  'Özel jet': 'Private jet',
  'Özel ada': 'Private island',
  "ADET": "PCS",
  ...
  "Fiyat bilgisi": "Price details",
  "Fırsat kaçtı": "Opportunity missed",
  "Game Center için iPhone uygulamasını kullan.": "Use the iPhone app for Game Center.",
  "Game Center · Top 100": "Game Center · Top 100",
  "Geri geldim. Son teklifini dinliyorum.": "I'm back. Let's hear your final offer.",
  "Görünüm": "Appearance",
  "Hafta tamamlandı": "Week completed",
  "Haftalık özet": "Weekly summary",
  "Müzik": "Music",
  "Müzik bu sürümde mevcut değil": "Music is not available in this release",
  "Müzik düzeyi": "Music volume",
  "Müşteri Akını": "Customer rush",
  "Müşteri dükkândan ayrıldı. Bir reklam izleyerek aynı müşteriyi geri çağır ve son teklifini yap.": "The customer left. Watch an ad to call them back and make one final offer.",
  "Müşteriyi geri çağır": "Call the customer back",
  "SAT": "SELL",
  "Satış miktarı": "Sale quantity",
  ...
  "TÜMÜ": "ALL",
  "Yeni haftaya başla": "Start next week",
  "Yükleniyor…": "Loading…",
  "{n} kayıtlı gün": "{n} recorded days",
  'Müşteri akını sürüyor — {dk} dakika kaldı.': 'Customer rush active — {dk} minutes remaining.',
  'Müşteri Akını — reklam izle, 90 oyun dakikası boyunca daha sık müşteri gelsin.': 'Customer rush — watch an ad for more frequent visits for 90 game minutes.',
  'Sistem': 'System',
  'Açık tema': 'Light',
  'Koyu tema': 'Dark',
};
