...
check(sceneDelegate.includes('MihenkBridgeViewController()') && read('ios/App/App/MihenkGameCenterPlugin.swift').includes('class MihenkBridgeViewController: CAPBridgeViewController'), 'iOS tam ekran köprü denetleyicisi hazır');
